...
(cl:defmethod cl:initialize-instance :after ((m <CollisionMap>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CollisionMap)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sdf_pub-msg:<CollisionMap> is deprecated: use sdf_pub-msg:CollisionMap instead.")))
