...
if(sdf_pub_CONFIG_INCLUDED)
  return()
endif()
set(sdf_pub_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(sdf_pub_SOURCE_PREFIX /home/edmund/test_ws/src/sdf_pub)
  set(sdf_pub_DEVEL_PREFIX /home/edmund/test_ws/devel)
  set(sdf_pub_INSTALL_PREFIX "")
  set(sdf_pub_PREFIX ${sdf_pub_DEVEL_PREFIX})
else()
  set(sdf_pub_SOURCE_PREFIX "")
  set(sdf_pub_DEVEL_PREFIX "")
  set(sdf_pub_INSTALL_PREFIX /home/edmund/test_ws/install)
  set(sdf_pub_PREFIX ${sdf_pub_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'sdf_pub' is deprecated")
...
set(sdf_pub_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/edmund/test_ws/devel/include;/home/edmund/test_ws/src/sdf_pub/include;/usr/include/eigen3;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(sdf_pub_INCLUDE_DIRS "")
  set(_include_dirs "/home/edmund/test_ws/devel/include;/home/edmund/test_ws/src/sdf_pub/include;/usr/include/eigen3;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/edmund/test_ws/devel/lib;/home/edmund/BNUKsearch_ws/devel/lib;/home/edmund/test_ws/devel/lib;/home/edmund/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(sdf_pub_LIBRARY_DIRS ${lib_path})
      list(APPEND sdf_pub_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'sdf_pub'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND sdf_pub_LIBRARIES ${lib})
    endif()
  endif()
...
set(sdf_pub_EXPORTED_TARGETS "sdf_pub_generate_messages_cpp;sdf_pub_generate_messages_eus;sdf_pub_generate_messages_lisp;sdf_pub_generate_messages_nodejs;sdf_pub_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${sdf_pub_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "rospy;std_msgs;sensor_msgs;visualization_msgs;image_transport;cv_bridge;arc_utilities;message_runtime")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 sdf_pub_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${sdf_pub_dep}_FOUND)
      find_package(${sdf_pub_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${sdf_pub_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(sdf_pub_INCLUDE_DIRS ${${sdf_pub_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(sdf_pub_LIBRARIES ${sdf_pub_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${sdf_pub_dep}_LIBRARIES})
  _list_append_deduplicate(sdf_pub_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(sdf_pub_LIBRARIES ${sdf_pub_LIBRARIES})

  _list_append_unique(sdf_pub_LIBRARY_DIRS ${${sdf_pub_dep}_LIBRARY_DIRS})
  list(APPEND sdf_pub_EXPORTED_TARGETS ${${sdf_pub_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "sdf_pub-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${sdf_pub_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
